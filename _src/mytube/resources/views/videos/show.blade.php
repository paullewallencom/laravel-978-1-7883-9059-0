        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
				...
				@if ($video->isProcessed() && $video->canBeAccessed(Auth::user()))
				    <video-player video-uid="{{ $video->uid }}" video-url="{{ $video->getVideoUrl() }}" thumbnail-url="{{ $video->getThumbnail() }}"></video-player>
				@endif
				        ...
				        <div class="media">
				            <div class="media-left">
				                <a href="/channel/{{ $video->channel->slug }}">
				                    <img src="{{ $video->channel->getAvatarImage() }}" width="40" height="40" alt="">
				                </a>
				            </div>
				...
				<div class="panel panel-default">
                    <div class="panel-body">
                        @if ($video->commentsAllowed())
                            <comments video-uid="{{ $video->uid }}"></comments>
                        @else
